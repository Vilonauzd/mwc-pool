            ...
            <Card>
              <CardBody>
                <div className="account__head">
                  ...
                  <span className="account__logo"> MWC
                  <span className="account__logo-accent">Pool</span>
                  </span>
                  </h3>
                  <h4 className="account__subhead subhead">Start mining MWC today</h4>
                </div>
                ...
                <Form className='login-form'>
                  ...
                  <FormGroup check>
                    <Label for='terms-of-service' check>
                      <Input onChange={this.onCheckboxChange} className={`form-control`} style={{ height: '16px', width: '16px' }} type="checkbox" required />{'  '}<span className={redSyntax} >By checking this box you agree to the MWCPool <NavLink className={redSyntax} to='/terms-of-service'>Terms of Service</NavLink></span>
                    </Label>
                  </FormGroup>
                  <br />
