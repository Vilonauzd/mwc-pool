...
export class MWCPoolSharesSubmittedComponent extends Component {
  UNSAFE_componentWillMount () {
    const { fetchMWCPoolSharesSubmitted } = this.props
    fetchMWCPoolSharesSubmitted()
  }

  componentDidUpdate (prevProps) {
    const { latestBlockHeight, fetchMWCPoolSharesSubmitted } = this.props
