...
print("Will add {} to users current balance of {} for a new balance of {}".format(amount, float(user_utxo.amount)/NANOmwc, float(user_utxo.amount)/NANOmwc+amount))
if debit_pool == "y":
    print("Will subtract {} from pool admin current balance of {} for a new balance of {}".format(amount, float(pooladmin_utxo.amount)/NANOmwc, float(pooladmin_utxo.amount)/NANOmwc-amount))
...
# Do it
user_utxo.amount += amount*NANOmwc
if debit_pool == "y":
    pooladmin_utxo.amount -= amount*NANOmwc

# Sanity Check
print("")
print("Users updated balance: {}".format(float(user_utxo.amount)/NANOmwc))
if debit_pool == "y":
    print("Pools updated balance: {}".format(float(pooladmin_utxo.amount)/NANOmwc))
