...
amount = payout_record.amount / float(NANOmwc)
...
print("Will cancel payout {} and add {} to users current balance of {} for a new balance of {}".format(payout_id, amount, float(user_utxo.amount)/NANOmwc, float(user_utxo.amount)/NANOmwc+amount))
