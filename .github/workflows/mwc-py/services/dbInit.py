...
def main():
    ...
    LOGGER.warning("Got Config: db_address: {}, db_port: {}, db_user: {}, db_password: {}, db_name: {}".format(db_address, db_port, db_user, db_password, db_name))
    ...
    conn.close()
    LOGGER.warning("Created db: {}".format(db_name))
    ...
    ##
    # Admin
    LOGGER.warning("Validate Admin user account")
    try:
